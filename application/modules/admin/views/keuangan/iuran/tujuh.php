            ...
            <div class="widget-box widget-box-header">
              ...
              <div class="widget-title">
                <ul class="nav nav-tabs">
                  ...
                  <li class="active"><a data-toggle="tab3" href="<?= site_url('admin/iuran/tujuh')?>" title="Lokasi iuran" class="tip-bottom">Iuran 2017</a></li>
                    ...
                    <table class="table table-bordered data-table" id="example">
                      <thead>
                        ...
                        <tr>
              			...
              			<?php $no=1;foreach($tujuh->result_array() as $lapan) { ?>
                      	<tr>
	                      	<td> <?php echo $no ?> </td>
