            ...
            <div class="widget-box widget-box-header">
              ...
              <div class="widget-title">
                <ul class="nav nav-tabs">
                   <li class="active"><a data-toggle="tab3" href="<?= site_url('admin/iuran/index')?>" title="Lokasi iuran" class="tip-bottom">iuran</a></li>
                      ...
                      <thead>
                        ...
                        <tr>
                      	...
                      	<tr>
	                      	...
	                      	<td> <a href="<?= site_url('admin/iuran/lapan_detail/'.$lapan['kid'])?>"><?php echo $lapan['kepala'];?></a> </td>
                      ...
                      <thead>
                        ...
                        <tr>
                      	...
                      	<tr>
	                      	...
	                      	<td> <?php echo $datas['bloks'];?></td>
	                      	<td> <a href="<?= site_url('admin/iuran/tujuh_detail/'.$datas['kid'])?>"><?php echo $datas['kepala'];?></a></td>
                    ...
                    <table class="table table-bordered data-table" id="example">
                      <thead>
                        ...
                        <tr>
                      	...
                      	<tr>
	                      	<td> <?php echo $no ?> </td>
	                      	<td> <?php echo $enam['no_kk'];?> </td>
	                      	<td> <?php echo $enam['bloks'];?> </td>
	                      	<td> <a href="<?= site_url('admin/iuran/enam_detail/'.$enam['kid'])?>"> <?php echo $enam['kepala'];?> </a></td>
